...
// const promise1 = new Promise((resolve) => setTimeout(() => resolve('Promise 1 completed'), 5000)); // upload anh
// const promise2 = new Promise((resolve) => setTimeout(() => resolve('Promise 2 completed'), 3000)); // add data
...
// const Func = async (promise1, promise2) => {
...
// const promise1 = () => new Promise((resolve) => setTimeout(() => resolve('Promise 1 completed'), 5000));
// const promise2 = () => new Promise((resolve) => setTimeout(() => resolve('Promise 2 completed'), 3000));
...
// for (let i = 0; i < 5; i++) {
//     promise1().then((results) => console.log(i, results))
// }
// console.timeEnd('executionTime');
